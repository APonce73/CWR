    ...
    #  TT <- paste(Goldberg$Raza_primaria)
      leaflet() %>%
        ...
        addCircleMarkers(Goldberg$long, Goldberg$lat, 
                         weight = 8, radius = 4, stroke = F, fillOpacity = 0.7, color = Goldberg$RatingCol,  
                         popup = paste(sep = " ",
                                       "Especie:",Goldberg$especie,"<br/>",
                                       "Subespecie:",Goldberg$subespecie,"<br/>", 
                                       "Fuente:",Goldberg$source, "<br/>",
                                       "Compilador:",Goldberg$compiler)) %>%
